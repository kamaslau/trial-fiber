...
func (ec *executionContext) field_Mutation_createPost_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNcreatePostInput2appᚋgraphᚋmodelᚐCreatePostInput(ctx, tmp)
	}
...
func (ec *executionContext) unmarshalInputcreatePostInput(ctx context.Context, obj any) (model.CreatePostInput, error) {
	...
	fieldsInOrder := [...]string{"name", "content", "excerpt"}
...
func (ec *executionContext) unmarshalNcreatePostInput2appᚋgraphᚋmodelᚐCreatePostInput(ctx context.Context, v any) (model.CreatePostInput, error) {
